        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="view.php?id=<?php echo $row["id"]; ?>" class="btn btn-sm btn-success mx-1">view</a>
                        <a href="update.php?id=<?php echo $row["id"]; ?>" class="btn btn-sm btn-warning mx-1">update</a>
